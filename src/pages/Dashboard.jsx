      ...
      <KPICards
        ...
        items={[
          ...
          },
          {
            ...
            subtitle: `${((data?.totals?.profitInRange / (data?.totals?.revenueInRange || 1)) * 100).toFixed(1)}% margin`,
            icon: TrendingUp,
            iconColor: "text-emerald-600",
            borderColor: "border-l-emerald-500",
            trend: data?.totals?.profitInRange > 0 ? "up" : "down",
            trendValue: `${((data?.totals?.profitInRange / (data?.totals?.revenueInRange || 1)) * 100).toFixed(1)}%`,
          },
        ]}
      />
