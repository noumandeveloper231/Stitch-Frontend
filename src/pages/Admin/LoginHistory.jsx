...
export default function LoginHistory() {
  ...
  return (
    <div className="p-6">
        ...
        <div className="mt-6">
          <KPICards
            ...
            items={[
              ...
              {
                title: "Unique Users",
                value: new Set(history.map((h) => h.userId?._id || h.userId)).size,
                icon: UserCheck,
      ...
      <div className="mt-6 flex flex-col p-4 gap-4 rounded-lg border border-zinc-200 bg-white shadow-sm">
