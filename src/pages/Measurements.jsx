...
import { PlusIcon, SearchIcon, Ruler, Users } from "lucide-react";
      ...
      {!loading && meta.total !== undefined && (
        <KPICards
          ...
          items={[
            ...
            {
              title: "Customers with Measurements",
              value: new Set(rows.map((r) => r.customerId?._id || r.customerId).filter(Boolean)).size,
              icon: Users,
