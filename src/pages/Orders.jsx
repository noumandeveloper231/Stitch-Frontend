...
import { SearchIcon, Eye, Loader2, CheckCircle2, Pencil, Trash2, FileCodeIcon, PlusIcon, ShoppingCart, DollarSign, Clock } from "lucide-react";
...
export default function Orders() {
  ...
  useEffect(() => {
    api.get("/orders/summary").then(({ data }) => setSummary(data.data)).catch(() => { });
  }, []);
